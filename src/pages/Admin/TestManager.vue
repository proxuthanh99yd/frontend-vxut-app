<template>
  <b-container>
    <el-page-header class="m-2" @back="goBack" content="Test"></el-page-header>
    <b-card>
...
export default {
  ...
  methods: {
    ...
    ...mapActions("test", ["storeTestRequest"]),
    ...mapActions("test", ["updateTestRequest"]),
    ...mapActions("test", ["destroyTestRequest"]),
    ...
    handleSubmit() {
      ...
      if (this.formData.isEdit == true) {
        ...
        this.isBusy = true;
        this.updateTestRequest(this.formData).then(() => {
          this.getCustomers();
        });
      } else {
        ...
        this.formData.level_id = this.level_id;
        this.isBusy = true;
        this.storeTestRequest(this.formData).then(() => {
          this.getCustomers();
        });
      }
