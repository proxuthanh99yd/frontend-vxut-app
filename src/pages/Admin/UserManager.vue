<template>
  <b-container>
    <el-page-header class="m-2" @back="goBack" content="Users"></el-page-header>
    <b-card>
      ...
      <b-overlay :show="show" rounded="sm">
        ...
        >
          ...
          <template v-if="user.role_id == 1" #cell(actions)="row">
            <b-button
      ...
      >
        <b-form ref="form" @submit.stop.prevent="handleSubmit">
          ...
          <b-form-group label="Test Level" label-for="input-2">
            <b-form-select
              id="input-2"
              v-model="role_id"
              :options="options"
...
export default {
  ...
  methods: {
    ...
    ...mapActions("users", ["storeUsersData"]),
    ...mapActions("users", ["activeUsersData"]),
    ...
    edit(item, index, button) {
      ...
      this.formData.role_id = item.role_id;
    ...
    handleSubmit() {
      ...
      if (this.formData.isEdit == true) {
        ...
        this.isBusy = true;
        this.storeUsersData(this.formData).then(() => {
          this.getCustomers();
        });
      }
    ...
    MsgBoxDel(item, index, button) {
      this.$bvModal
        ...
        .then((value) => {
          if (value === true) {
            this.isBusy = true;
            this.destroyTestRequest(item.id).then(() => {
              this.getCustomers();
            });
          }
        })
