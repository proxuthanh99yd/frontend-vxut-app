          ...
          <template #cell(name)="data">
            <router-link
              :to="{
                ...
                params: { flashcards_manager_id: data.item.id },
              }"
...
export default {
  ...
  created() {
    this.getAdminAllFlashcardsData();
  },
  data() {
    return {
      isBusy: false,
  ...
  computed: {
    ...mapGetters({
      clientFlashcardManager: "myFlashcard/myFlashcard",
    }),
    sortOptions() {
  ...
  methods: {
    ...mapActions("myFlashcard", ["getAdminAllFlashcardsData"]),
